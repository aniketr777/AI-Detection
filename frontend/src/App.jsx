...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] text-slate-100 flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      {/* Main Navbar */}
      <header className="sticky top-0 z-30 backdrop-blur-md bg-[#0b0f19]/80 border-b border-slate-800/80 px-4 sm:px-8 py-3.5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Celebrity Radar & Client/Server Inspector</p>
            </div>
          </div>
      ...
      {/* Main Content Area */}
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 py-8 w-full flex-1 flex flex-col gap-10">
        ...
        {/* ------------------------------------------------------------- */}
        {/* TOP SECTION: POPULAR CELEBRITIES SHOWCASE                     */}
        {/* ------------------------------------------------------------- */}
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-400 mt-1">
                Explore worldwide cultural icons, film legends, record-breaking artists, and sports stars.
              </p>
            </div>
        ...
        {/* ------------------------------------------------------------- */}
        {/* BOTTOM SECTION: REQUESTING MACHINE & SERVER DIAGNOSTICS      */}
        {/* ------------------------------------------------------------- */}
        <section className="space-y-6 pt-4 border-t border-slate-800/80">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl bg-slate-900/80 border border-slate-800 p-6 flex flex-col justify-between hover:border-slate-700/80 transition-all shadow-lg shadow-black/20">
              ...
              <div className="mt-4 pt-3 border-t border-slate-800/60 flex items-center justify-between text-[11px] text-slate-500">
                <span>Secure (HTTPS): <strong className="text-slate-300">{clientInfo?.client?.secure ? 'Yes' : 'No (Local/HTTP)'}</strong></span>
            ...
            <div className="rounded-2xl bg-slate-900/80 border border-slate-800 p-6 flex flex-col justify-between hover:border-slate-700/80 transition-all shadow-lg shadow-black/20">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-slate-800">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400">Node.js backend execution node</p>
                    </div>
                  </div>
                ...
                <div className="mt-5 space-y-3 text-xs">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950/70 border border-slate-800/80 flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-mono text-sm font-semibold text-slate-200 mt-0.5">
                        {clientInfo?.server?.hostname || 'LAPTOP-HOST'}
                      </p>
                    </div>
                  ...
                  <div className="p-3 rounded-xl bg-slate-950/70 border border-slate-800/80 space-y-1">
                    ...
                    <p className="text-xs text-slate-300 font-medium truncate">
                      {clientInfo?.server?.cpuModel || 'Intel / AMD Processor'}
                    </p>
                  </div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-800/60 flex items-center justify-between text-[11px] text-slate-500">
                ...
                <span>Env: <strong className="text-emerald-400">{clientInfo?.server?.environment || 'dev'}</strong></span>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-slate-800/80 py-6 px-4 text-center text-xs text-slate-500 relative z-10">
        <p>OmniPulse Dashboard • Powered by Express Node.js & React 19 • Running on Windows 11</p>
      </footer>
    </div>
  );
}
